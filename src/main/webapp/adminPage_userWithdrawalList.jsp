	...
	$.ajax({
		...
		success: function(userList){
			...
			for(var i in userList){
				...
				temp += "	<td>" + "<button type=\"button\" onclick=\'recovery(" + userList[i].user_no + ")\'>복구</button>" + "</td>";
				temp += "</tr>";
			}
...
<script>
	function recovery(no){
		if(confirm("블랙을 해제 하겠습니까?")){
			location.href='./adminUserRecovery?user_no=' + no;
		} else{
			location.href='./adminPage_userWithdrawalList';
		}
	}
