...
<body>
	<div id="main">
		<h1>글수정하기</h1>
		<form action="./reportupdate" method="post" onsubmit="return check()">
			<input type="text" id="title" name="title" value="${dto.reportboard_title }" placeholder="제목을 입력하세요">
			<textarea id="summernote" name="comment">${dto.reportboard_comment }</textarea>
